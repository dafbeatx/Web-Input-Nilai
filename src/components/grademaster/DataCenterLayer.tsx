...
export default function DataCenterLayer({ onBack }: DataCenterLayerProps) {
  ...
  const isAnyActionActive = isLoading || isSubmitting || isDownloadingClassAcademicPdf || isDownloadingClassBehaviorPdf || downloadingAcademicId !== null || downloadingBehaviorId !== null;
    ...
    <div className="font-body text-on-surface selection:bg-tertiary/30 min-h-dvh flex flex-col bg-surface relative overflow-x-hidden">
                       ...
                       <td className="p-4">
                         <div className="flex items-center justify-end gap-2 opacity-100 sm:opacity-0 sm:group-hover:opacity-100 transition-opacity">
                            <button 
                              ...
                              disabled={isAnyActionActive}
                              className="p-2 bg-emerald-500/10 text-emerald-600 hover:bg-emerald-600 hover:text-white rounded-lg transition-colors active:scale-90 disabled:opacity-50 disabled:cursor-not-allowed"
                            ...
                            <button 
                               ...
                               disabled={isAnyActionActive}
                               className="p-2 bg-rose-500/10 text-rose-600 hover:bg-rose-600 hover:text-white rounded-lg transition-colors active:scale-90 disabled:opacity-50 disabled:cursor-not-allowed"
                           ...
                           <button 
                             ...
                             disabled={isAnyActionActive}
                             className="p-2 bg-error/10 text-error hover:bg-error hover:text-white rounded-lg transition-colors active:scale-90 disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      {isExcelImport && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className={`bg-surface rounded-3xl p-6 w-full relative z-10 border border-outline-variant/20 shadow-2xl animate-in zoom-in-95 flex flex-col max-h-[85vh] transition-all duration-300 ${
            ...
            <div className="flex gap-3 mt-6 pt-4 border-t border-outline-variant/10">
              {wizardStep > 1 && (
                <button 
                  ...
                  className="flex-1 py-3 bg-surface-container text-on-surface-variant rounded-xl text-xs font-bold uppercase tracking-widest active:scale-95 transition-all border border-outline-variant/10 disabled:opacity-50 disabled:cursor-not-allowed"
                  disabled={isSubmitting}
                >
                  Kembali
                </button>
              ...
              {wizardStep === 2 && (
                <button 
                  ...
                  disabled={isSubmitting}
                  className="flex-1 py-3 bg-amber-500 text-white rounded-xl text-xs font-bold uppercase tracking-widest active:scale-95 hover:bg-amber-600 transition-all flex justify-center items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
                >
