          ...
          <div className="space-y-3">
            ...
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-14 pr-6 py-5 bg-white border-2 border-slate-100 rounded-3xl text-lg font-bold text-[#0F172A] placeholder:text-slate-300 focus:outline-none focus:border-[#0F172A] focus:ring-4 focus:ring-slate-100 transition-all shadow-sm disabled:opacity-50 disabled:cursor-not-allowed"
              />
