      ...
      <div className="w-full max-w-md bg-slate-900/40 backdrop-blur-xl rounded-[2.5rem] border border-white/10 shadow-2xl p-8 md:p-10 animate-in fade-in slide-in-from-bottom-5 duration-500">
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-2">
            <label className="text-[10px] font-black uppercase tracking-widest text-slate-500 ml-1">Username Siswa</label>
            <div className="relative group">
              ...
              <input
                ...
                className="w-full pl-12 pr-6 py-4 bg-white/5 border border-white/10 rounded-2xl text-sm font-bold text-slate-200 focus:outline-none focus:ring-4 focus:ring-emerald-500/10 focus:border-emerald-500/50 transition-all placeholder:text-slate-600"
                disabled={isLoading}
              />
            </div>
          </div>
        ...
        <div className="mt-10 pt-6 border-t border-white/5 text-center">
          <button 
            ...
            className="text-[10px] font-black text-slate-500 uppercase tracking-[0.2em] hover:text-primary transition-colors py-2 px-4 rounded-xl hover:bg-white/5 border border-transparent hover:border-white/10"
          >
