...
export async function POST(req: NextRequest) {
  try {
    // Basic API security check (e.g. check API key or admin authorization)
    // For local dev / testing, we allow direct execution, but validate payload
    ...
    console.error('[Push Send API] Crash:', err);
