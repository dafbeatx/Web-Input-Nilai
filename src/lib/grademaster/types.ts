...
export type Layer = 'home' | 'setup' | 'dashboard' | 'grading' | 'login' | 'remedial' | 'behavior' | 'remedial_dashboard' | 'attendance' | 'student_accounts' | 'student_login' | 'student_profile' | 'student_claim' | 'teacher_claim' | 'lesson_management' | 'remedial_management';
